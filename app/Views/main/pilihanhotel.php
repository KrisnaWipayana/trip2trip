...
<html lang="en">
  <head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Montserrat:wght@700&display=swap" rel="stylesheet">
     ...
     <!-- my Css-->
     <link href="assets/main/css/pilihhotel.css" rel="stylesheet" >
  </head>
  <body>
          ...
          <div class="col-12 hotel-panel">
              ...
              <div class="row">
                  <div class="col-lg">
                    <div class="card-deck">
                      <div class="card" href="#">
                        <img class="card-img-top" src="assets/main/img/box1.jpg" alt="Card image cap">
                        <div class="card-body">
